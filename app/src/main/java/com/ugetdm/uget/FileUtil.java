...
public final class FileUtil {
    ...
    @Nullable
    public static String getFullPathFromDocumentUri(@Nullable final Uri documentUri, Context con) {
        if (documentUri == null) {
            return null;
        }
        String volumePath = FileUtil.getVolumePath(FileUtil.getVolumeIdFromDocumentUri(documentUri),con);
        if (volumePath == null) {
        ...
        String documentPath = FileUtil.getDocumentPathFromDocumentUri(documentUri);
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    private static String getVolumeIdFromDocumentUri(final Uri documentUri) {
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    private static String getDocumentPathFromDocumentUri(final Uri treeUri) {
